...
public class ResultController {
    ...
    @GetMapping("/resultsByQuestion")
public ResponseEntity<List<ResultInfo>> getResultsByQuestion(
        @RequestParam String questionSetId,
        @RequestParam int questionNo) {
    List<ResultInfo> resultInfos = resultService.getResultInfoByQuestionSetIdAndQuestionNo(questionSetId, questionNo);
